...
/**
 * Widget configuration for widgets displaying a list of hidden operations
 *
 * @author Karsten Nowak <captnnowi@gmx.de>
 */
class ListOfHiddenOperationsWidget implements WidgetInterface, AdditionalCssInterface, RequestAwareWidgetInterface
{
    ...
    public function renderWidgetContent(): string
    {
        ...
        return $this->backendViewFactory
            ...
            ->render('Widget/ListOfHiddenOperationsWidget');
    }
