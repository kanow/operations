...
Im :ref:`Frontend <t3start:concepts>` sind verschiedene Darstellungen möglich.
...
.. note::
   ...
   - Einsatzstatistik gruppiert nach Jahr und Einsatztyp mit einem
     Balkendiagramm und/oder einer Tabelle (`Chart.js <https://chartjs.org>`_)
...
.. tip::
   ...
   `Hier spenden <https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=ZFPCNRYPD2MGA&source=url>`_

.. note::

   Icons für die Daten im Backend:

   - Icon für Einsätze von `Julián Humberto Corrales <https://www.thenounproject.com>`_
   - Icon für Hilfsmittel von `Antonio Vicién Faure <https://www.thenounproject.com/antoniopolonio>`_
   - Icon für Fahrzeuge: "Firetruck" von Rohan Gupta im `Noun Project <https://thenounproject.com/rohangupta1>`_
